      ...
      <div className="mx-auto max-w-7xl px-5 md:px-6">
        <div className="flex flex-col items-start justify-between gap-5 md:flex-row md:items-end md:gap-6">
          <div>
            ...
            <h2 className="max-w-3xl font-display text-3xl font-black leading-[1.05] md:text-5xl">
              {he.testimonials.title}
            </h2>
          </div>
          <div className="flex items-center gap-3 rounded-full border border-white/15 bg-white/[0.05] px-4 py-2 text-sm text-fg/90 backdrop-blur md:px-5 md:py-2.5">
            <span className="flex -space-x-1">
              {["#7C3AED", "#22D3EE", "#F0ABFC", "#F472B6"].map((c) => (
                <span
                  key={c}
                  className="h-6 w-6 rounded-full border-2 border-ink-950"
                  style={{ background: c }}
                />
              ))}
            </span>
        ...
        <div className="mt-10 grid gap-4 md:mt-16 md:grid-cols-2 md:gap-6">
          {he.testimonials.items.map((t, i) => (
            ...
            >
              ...
              <div
                dir="ltr"
                className="relative font-display text-5xl font-black leading-none gradient-text md:text-7xl"
              >
                "
              </div>
              ...
              <div className="relative mt-6 flex items-center gap-3 border-t border-white/10 pt-5 md:mt-8 md:gap-4 md:pt-6">
                ...
                <div className="mr-auto flex gap-0.5 text-sm text-neon-cyan">
                  ★★★★★
                </div>
              </div>
            </motion.div>
