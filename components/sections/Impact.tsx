  ...
  return (
    <section className="relative overflow-hidden py-20 md:py-32">
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-6">
        ...
        <h2 className="max-w-4xl font-display text-3xl font-black leading-[1.05] md:text-5xl">
          {he.impact.title}
        </h2>

        <div className="mt-10 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-white/10 bg-white/5 md:mt-20 md:grid-cols-4 md:rounded-3xl">
