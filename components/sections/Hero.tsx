...
export default function Hero() {
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 z-[1] bg-[radial-gradient(ellipse_at_center,transparent_0%,rgba(5,6,14,0.9)_80%)]"
      />
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1400px] flex-1 flex-col justify-center px-5 pt-28 pb-14 pointer-events-none md:px-10 md:pt-32 md:pb-16">
        ...
        <motion.p
          ...
          className="mt-6 max-w-2xl text-base leading-relaxed text-fg/80 md:mt-8 md:text-xl"
        >
          {he.hero.subtitle}
        </motion.p>
